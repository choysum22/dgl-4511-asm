                    ...
                    <div class="row">
                        <div class="container overflow-auto" id="content-container">
                            <form action="staffAccount" method="post" runat="server" >
                                <div class="row">
                                    <div class="col-6">
                                        <input class='form-control' type="hidden" name="action" value="addStaff"/>
                                        ...
                                        <div id="trainerInput" style="display:none">
                                            </br>
                                            Profile Image: </br>

                                            <input class='form-control' type="file" name="temp_img" id="temp_img" onchange="getFileData(this);"/>
                                            <input class='form-control' type="hidden" id="img" name="img" value=""/>
                                            </br>
